...
class Product(models.Model):
    ...
    size = models.CharField(max_length=20,default="",null=True,blank=True)
...
status = ((0,"Order Placed"),(1,"Not Packed"),(2,"Packed"),(3,"Ready to Ship"),(4,"Shipped"),(5,"Out For Delevery"),(6,"Delivered"),(7,"Cancelled"))
